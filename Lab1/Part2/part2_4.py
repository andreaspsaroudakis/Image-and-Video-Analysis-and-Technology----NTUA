...
def OpticalFlow(video_path,feature_params,lk_params,line_length,color):
...
if __name__ == "__main__":
    ...
    lk_params = dict(winSize = (15,15), maxLevel = 4, criteria = (cv.TERM_CRITERIA_EPS | cv.TERM_CRITERIA_COUNT, 2, 0.03))
    ...
    OpticalFlow(video_path,feature_params,lk_params,line_length,color)
